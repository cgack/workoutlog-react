	  ...
	  _createClass(WorkoutLog, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        this.state.view === "store" ? _react2.default.createElement(_store2.default, null) : "",
	        this.state.view === "history" ? _react2.default.createElement(_history2.default, null) : ""
	      );
	    }
	  }, {
	    key: '_onNav',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DefineWorkout = function (_React$Component) {
		...
		function DefineWorkout() {
			...
			return _possibleConstructorReturn(this, Object.getPrototypeOf(DefineWorkout).apply(this, arguments));
		}
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						{ htmlFor: "defineName" },
						"Define Name",
						_react2.default.createElement("input", { type: "text", id: "defineName" })
					),
					_react2.default.createElement(
						"label",
						{ htmlFor: "defineType" },
						"Define Type",
						_react2.default.createElement("input", { id: "defineType", type: "text" })
					),
					_react2.default.createElement(
						"label",
						{ htmlFor: "defineDesc" },
					...
					_react2.default.createElement("textarea", { id: "defineDesc" }),
					_react2.default.createElement(
						"button",
						{ id: "saveDefinition" },
						"Save Definition"
	  ...
	  _createClass(StoreWorkout, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          "select",
	          { name: "", id: "chooseWorkout" },
	          this._mockWorkouts.map(function (result) {
	            return _react2.default.createElement(Option, { key: result.id, value: result.name });
	          })
	        ),
	        _react2.default.createElement(
	          "label",
	          { htmlFor: "workoutResult" },
	          "Result:"
	        ),
	        _react2.default.createElement("input", { id: "workoutResult", type: "text" }),
	        _react2.default.createElement("input", { id: "workoutDate", type: "date" }),
	        _react2.default.createElement(
	          "label",
	          { htmlFor: "notes" },
	          "Notes:"
	        ),
	        _react2.default.createElement("textarea", { id: "notes" }),
	        _react2.default.createElement(
	          "button",
	          null,
	          "Store"
...
/***/ function(module, exports, __webpack_require__) {
	...
	var History = function (_React$Component2) {
	  ...
	  function History() {
	    ...
	    var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(History).call(this));
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          this._mockHistory.map(function (result) {
	            ...
	            return _react2.default.createElement(ListItem, _extends({ key: result.id }, histObj));
	          })
	        )
	      );
	    }
